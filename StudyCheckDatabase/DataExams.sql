...
go 
insert into UyeDetay (uye_id,kullanici_adi,kullanici_sifre,kullanici_mail,kayit_tarihi,guncelleme_tarihi,sil_id,tema_id,rol_id)
values (1,'admin','admin123','steve@mail',GETDATE(),GETDATE(),1,1,1)
go
