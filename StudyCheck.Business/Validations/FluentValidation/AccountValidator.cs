    ...
    {        
        public AccountValidator()
        {
            ...
            RuleFor(x => x.kullanici_adi).NotEmpty().WithMessage("Kullanıcı adı boş geçilemez.")
                ...
                .Matches(Utility.regexTR).WithMessage("Kullanıcı adı özel karakterler içeremez.");
            RuleFor(x=>x.kullanici_sifre).NotEmpty().WithMessage("Kullanıcı şifresi boş geçilemez.")
                ...
                .Matches(Utility.regex).WithMessage("Kullanıcı şifresi özel/türkçe karakterler içeremez.");
